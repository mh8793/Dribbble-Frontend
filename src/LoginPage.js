    ...
    <div className="lg:flex h-screen">
      <div className="lg:w-1/3 bg-[#f2d184] p-6 flex items-center justify-center gap-y-2 ">
        ...
        <h1 className="sm:font-bold lg:font-bold text-[#866216] font-serif text-3xl mb-4">Discover the world's top Designers & Creatives.</h1>
          ...
          <p className="lg:absolute left-2 bottom-2 text-sm text-[#866216]"><button href="https://www.freepik.com/free-vector/user-research-concept-illustration_21532506.htm#query=website%20illustration&position=14&from_view=keyword&track=ais&uuid=7271c107-3f2f-448c-a975-13e3245aa0a3">Image by storyset</button> on Freepik</p>
        </div>
      </div>

      <div className="w-2/3 bg-white flex items-center justify-center gap-y-2">
      <div className="absolute gap-2 top-2 right-4 flex p-2">
          <p>Already a member?</p> <button className='text-[#4d4593]'>Sign In</button>
        </div>
